...
import com.shestikpetr.meteoapi.service.mapper.StationDataMapper
...
class SensorDataService(
    ...
    fun latestForStation(
        ...
        val values = activeCodes.map { code ->
            StationDataMapper.toParameterWithValue(code, metadata[code], latestRow?.values?.get(code))
        }
        return StationDataMapper.toResponse(link, latestRow?.time, values)
    }
